                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                <h2 style="text-align:center; margin-top: 10px; font-family: sans-serif;">Welcome <?php echo htmlentities($row['firstname']);?> to Darzi.pk</h2>
                                ...
                                <div class="col-md-8">
                                    <div class="profileDetails">
                                        ...
                                        <div class="row" style="border-bottom: 0.5em white;">
                                            <div class="chngbtn">
                                                <a class="btn btn-info " target="__blank"  href="updateprofile.php">Update Profile Details</a>
                                            </div>
