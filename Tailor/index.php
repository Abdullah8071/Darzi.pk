...
$ret=mysqli_query($con,"SELECT * FROM tailor WHERE email='$email' and password='$password'");
...
<head>
	...
	<title>Darzi.pk | Tailor login</title>
			...
			<div class="row">
				<div class="module module-login span4 offset4">
					<form class="form-vertical" method="post">
						...
						<div class="control-group">
                                <label class="control-label" for="basicinput" style="color:black;font-weight:bold">New User ? </label>
                                <div class="controls row-fluid">
								<a href="register.php" ><button type="button" class="btn btn-info pull-left" > Register</button> </a>
